 ...
 */
final class Version20190112172616 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles VARCHAR(10) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles VARCHAR(255) DEFAULT \'\' COLLATE utf8mb4_unicode_ci');
    }
}
