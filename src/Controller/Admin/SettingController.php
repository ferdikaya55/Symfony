...
class SettingController extends AbstractController
{
    ...
    public function index(SettingRepository $settingRepository): Response
    {
       ...
       //dump($setdata);
        ...
        return $this->redirectToRoute('admin_setting_edit', ['id' => $setdata[0]->getId()]); // 0 ilk satırın id sini gönder demek.
        //return $this->render('admin/setting/index.html.twig', ['settings' => $settingRepository->findOneBy()]);
    }
    ...
    public function edit(Request $request, Setting $setting): Response
    {
        ...
        if ($form->isSubmitted() ) {
            ...
            $this->addFlash('success','Güncelleme Başarılı'); // tek kullanımlık bir komuttur
