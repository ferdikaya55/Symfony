...
class MessagesController extends AbstractController
{
    ...
    public function show(Messages $message,$id): Response
    {
        ...
        $em=$this->getDoctrine()->getManager();
        $sql= 'UPDATE messages SET status="Okundu" WHERE id=:id'; // güvenlik açığı olmasın diye parametreli sql cümlesi
        $statement=$em->getConnection()->prepare($sql);
        $statement->bindValue('id', $id); // parametre
        $statement->execute();
     ...
     */
    public function message_update(Request $request,$id, Messages $message): Response
    {
        $em=$this->getDoctrine()->getManager();
        $sql= "UPDATE messages SET comment=:comment WHERE id=:id"; // güvenlik açığı olmasın diye parametreli sql cümlesi
        $statement=$em->getConnection()->prepare($sql);
